...
export async function trackCategorySpecSearchView(payload: Payload) {
...
function setVariables(payload: Payload) {
	...
	window.sc_class_name = 'Products List Pages';
	...
	window.sc_proevents = 'event12';
	window.sc_sort_type = 'default(pv)';
}
