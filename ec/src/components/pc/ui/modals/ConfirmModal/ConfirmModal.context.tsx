 ...
 * // Basic usage
 * const handler = async () => {
 *   // "showConfirm" will return "Promise"
 *   await showConfirm('Shows this message in confirm modal.')
 *   nextProcess();
 * }
 *
 * // Advanced usage
 ...
 *     message: 'Shows this message in confirm modal.'
 *     confirmButton: <a href="...">jump to other page</a>
 *   })
 * }
 */
