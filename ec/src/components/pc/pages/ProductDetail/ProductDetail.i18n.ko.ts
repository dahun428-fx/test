...
import { productDetailsDownloadButton } from './ProductDetailsDownloadButton/ProductDetailsDownloadButton.i18n.ko'; // change to ko
import { productDetailsDownloadModal } from './ProductDetailsDownloadModal/ProductDetailsDownloadModal.i18n.ko'; // change to ko
