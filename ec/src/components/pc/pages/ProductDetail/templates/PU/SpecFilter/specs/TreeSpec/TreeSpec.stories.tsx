			...
			<dd>
				<TreeSpec
					{...{
						...
						spec: {
							...args.spec,
							// TODO:specValueListはAlterationSpecValueに存在しないたｍ一旦コメントアウト
							// specValueList: [
							// 	{
							// 		specValue: 'a',
							// 		specValueDisp: 'Steel',
							// 		hiddenFlag: '0',
							// 		specValueImageUrl: 'https://example.com/steel.png',
							// 		selectedFlag: '1',
							// 		childSpecValueList: [
							// 			{
							// 				specValue: '00000230940.a!00313',
							...
							// 				selectedFlag: '1',
							// 			},
							// 		] as unknown as string, // Todo Not sure why this type is string ?
							// 	},
