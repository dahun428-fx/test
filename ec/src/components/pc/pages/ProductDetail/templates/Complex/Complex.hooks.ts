...
export const useDetailTab = () => {
	...
	}, [categoryCodeList, categoryList, defaultTabInfo, tabType]);
	...
	const tabList = useMemo(() => {
		...
		return tabInfo;
	}, [checkedTabPositionInfo, isNotPartNumberListDefault, showsDetailInfo]);
...
/**
 * use complex meta hook
 */
export const useComplexMeta = () => {
