				...
				<>
					{cadData.fixed2DCadList.length > 0 && (
						<>
							...
							>
								{t(
									'components.domain.cadDownload.cadDownloadFixed.cad2d.title'
								)}
							</h3>
							...
							<p>
								{brandCode !== 'MSM1' && (
									<>
										{t('components.domain.cadDownload.cadDownloadFixed.first')}
										<br />
									</>
								)}
								{t('components.domain.cadDownload.cadDownloadFixed.second')}
								<br />
								{t('components.domain.cadDownload.cadDownloadFixed.third')}
							</p>
						</>
					)}
					...
					{cadData.fixed3DCadList.length > 0 && (
						<>
							...
							>
								{t(
									'components.domain.cadDownload.cadDownloadFixed.cad3d.title'
								)}
							</h3>
							<ul className={styles.linkListWrapper}>
				...
				cadData.cadSiteType && (
					<>
						<h3 className={styles.title}>
							{t('components.domain.cadDownload.cadDownloadFixed.cad2d.title')}
						</h3>
						<ul className={styles.alert}>
							<li>
								{t('components.domain.cadDownload.cadDownloadFixed.fourth')}
							</li>
						</ul>
					</>
				)
