...
import { useNewMessageArrivedToast } from '@/components/pc/ui/toasts/NewMessageArrivedToast.hooks';
import { useOnMounted } from '@/hooks/lifecycle/useOnMounted';
import { ga } from '@/logs/analytics/google';
import {
	useUpdateDatadogGlobalContext,
	useUpdateRumSessionUser,
} from '@/logs/datadog/hooks';
...
export const Effective: React.VFC = () => {
	...
	useOnMounted(() => {
		...
		if (!getCookie(Cookie.VONA_LOG_ID)) {
			setCookie(Cookie.VONA_LOG_ID, uuidv4().replaceAll('-', ''));
		}
